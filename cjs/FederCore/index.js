'use strict';
const Projector = (m => /* c8 ignore start */ m.__esModule ? m.default : m /* c8 ignore stop */)(require('../Utils/projector/index.js'));
const faissIndexParser = (m => /* c8 ignore start */ m.__esModule ? m.default : m /* c8 ignore stop */)(require('./faissIndexParser.js'));
const faissIVFFlatSearch = (m => /* c8 ignore start */ m.__esModule ? m.default : m /* c8 ignore stop */)(require('./faissIVFFlatSearch.js'));
const {
  ProjectMethod,
  getProjectFunc,
  getProjectParamsGuide
} = require('../Utils/projector/index.js');
...
/* Feder core class */
module.exports = class FederCore {
  constructor({
    data,
    source = 'faiss',
