...
export class TimeControllerView {
  moveSilderBar: Function;
  playPauseIconG: d3.Selection<SVGGElement, unknown, null, undefined>;
  playPauseG: d3.Selection<SVGGElement, unknown, null, undefined>;
  sliderBar: d3.Selection<
    SVGRectElement,
    { x: number; y: number },
    null,
    undefined
  >;
  resetG: d3.Selection<SVGGElement, unknown, null, undefined>;
  ...
  setTimer(timer: TimerController) {
